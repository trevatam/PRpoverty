...
knitr::kable(varnames8, "latex", booktabs=T)
```
...
knitr::kable(t(reg4tab), "latex", booktabs=T, caption = "Coefficients for Moderate vs. Extreme Poverty")%>%
...
knitr::kable(t(reg4tab3), "latex", booktabs=T, caption= "Coefficients for Vulnerable HH vs. Extreme Poverty")%>%
kable_styling(latex_options = "hold_position")  
...
knitr::kable(t(reg4tab4), "latex", booktabs=T, caption= "Coefficients for Non-Vulnerable HH vs. Extreme Poverty")%>%
kable_styling(latex_options = "hold_position")  
...
knitr::kable(testtab, "latex", booktabs=T, caption = "Confusion Matrix for MLR: Predicted Poverty Level")%>%
kable_styling(latex_options = "hold_position")  
```
